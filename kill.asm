...
main(int argc, char **argv)
{
  ...
  41:	e8 02 05 00 00       	call   548 <kill>
  for(i=1; i<argc; i++)
  46:	83 c4 10             	add    $0x10,%esp
  49:	39 de                	cmp    %ebx,%esi
  4b:	75 e3                	jne    30 <main+0x30>
  exit();
  4d:	e8 c6 04 00 00       	call   518 <exit>
    printf(2, "usage: kill pid...\n");
  52:	50                   	push   %eax
  53:	50                   	push   %eax
  54:	68 e8 0a 00 00       	push   $0xae8
  59:	6a 02                	push   $0x2
  5b:	e8 20 06 00 00       	call   680 <printf>
    exit();
  60:	e8 b3 04 00 00       	call   518 <exit>
  65:	66 90                	xchg   %ax,%ax
  67:	66 90                	xchg   %ax,%ax
  69:	66 90                	xchg   %ax,%ax
  6b:	66 90                	xchg   %ax,%ax
...
double atof(const char *s){
 ...
 385:	0f 87 9d 00 00 00    	ja     428 <atof+0x158>
  double divisor = 10.0;   
 38b:	d9 05 04 0b 00 00    	flds   0xb04
  double fraction = 0.0;  
 391:	d9 ee                	fldz
 ...
 3db:	d9 c9                	fxch   %st(1)
    divisor *= 10.0;
 3dd:	d8 0d 04 0b 00 00    	fmuls  0xb04
  while('0' <= *fractionPart && *fractionPart <= '9'){
...
double fsqrt(double n) {
 ...
 468:	dd 45 08             	fldl   0x8(%ebp)
    double newtonianGuess = n / 2.0;
 46b:	d9 c0                	fld    %st(0)
 46d:	d8 0d 08 0b 00 00    	fmuls  0xb08
    for (int i = 0; i < 20; i++) {
 ...
 486:	d8 0d 08 0b 00 00    	fmuls  0xb08
    for (int i = 0; i < 20; i++) {
 ...
 5c8:	89 d1                	mov    %edx,%ecx
{
 ...
 60b:	0f b6 92 64 0b 00 00 	movzbl 0xb64(%edx),%edx
 ...
 68c:	8b 4d 0c             	mov    0xc(%ebp),%ecx
{
 ...
 6f8:	ff 24 85 0c 0b 00 00 	jmp    *0xb0c(,%eax,4)
 6ff:	90                   	nop
  write(fd, &c, 1);
 ...
 7ef:	d9 7d d6             	fnstcw -0x2a(%ebp)
          fraction_part *= 10;
 7f2:	d8 0d 04 0b 00 00    	fmuls  0xb04
          int digit = (int) fraction_part;
 ...
 920:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 925:	bf fc 0a 00 00       	mov    $0xafc,%edi
...
free(void *ap)
{
 ...
 961:	a1 c4 0e 00 00       	mov    0xec4,%eax
{
 ...
 9a9:	5b                   	pop    %ebx
  freep = p;
 9aa:	89 15 c4 0e 00 00    	mov    %edx,0xec4
}
 9b0:	5e                   	pop    %esi
 9b1:	5f                   	pop    %edi
 9b2:	5d                   	pop    %ebp
 ...
 9e7:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 9ea:	89 15 c4 0e 00 00    	mov    %edx,0xec4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 a09:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 a0c:	8b 15 c4 0e 00 00    	mov    0xec4,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 a4b:	39 05 c4 0e 00 00    	cmp    %eax,0xec4
 ...
 a6e:	e8 ed fe ff ff       	call   960 <free>
  return freep;
 a73:	8b 15 c4 0e 00 00    	mov    0xec4,%edx
 ...
 a9c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 a9f:	89 15 c4 0e 00 00    	mov    %edx,0xec4
}
 ...
 aaf:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 ab0:	c7 05 c4 0e 00 00 c8 	movl   $0xec8,0xec4
 ab7:	0e 00 00 
    base.s.size = 0;
 aba:	b8 c8 0e 00 00       	mov    $0xec8,%eax
    base.s.ptr = freep = prevp = &base;
 abf:	c7 05 c8 0e 00 00 c8 	movl   $0xec8,0xec8
 ac6:	0e 00 00 
    base.s.size = 0;
 ac9:	c7 05 cc 0e 00 00 00 	movl   $0x0,0xecc
 ad0:	00 00 00 
    if(p->s.size >= nunits){
