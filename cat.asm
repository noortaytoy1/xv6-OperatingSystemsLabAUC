...
main(int argc, char *argv[])
{
  ...
  33:	6a 00                	push   $0x0
  35:	ff 33                	push   (%ebx)
  37:	e8 dc 05 00 00       	call   618 <open>
  ...
  57:	e8 a4 05 00 00       	call   600 <close>
  for(i = 1; i < argc; i++){
  ...
  exit();
  64:	e8 6f 05 00 00       	call   5d8 <exit>
      printf(1, "cat: cannot open %s\n", argv[i]);
  69:	50                   	push   %eax
  6a:	ff 33                	push   (%ebx)
  6c:	68 cb 0b 00 00       	push   $0xbcb
  71:	6a 01                	push   $0x1
  73:	e8 c8 06 00 00       	call   740 <printf>
      exit();
  78:	e8 5b 05 00 00       	call   5d8 <exit>
    cat(0);
  7d:	83 ec 0c             	sub    $0xc,%esp
  80:	6a 00                	push   $0x0
  82:	e8 09 00 00 00       	call   90 <cat>
    exit();
  87:	e8 4c 05 00 00       	call   5d8 <exit>
  8c:	66 90                	xchg   %ax,%ax
  8e:	66 90                	xchg   %ax,%ax
...
00000090 <cat>:
{
  ...
  a9:	6a 01                	push   $0x1
  ab:	e8 48 05 00 00       	call   5f8 <write>
  ...
  c4:	56                   	push   %esi
  c5:	e8 26 05 00 00       	call   5f0 <read>
  ...
  df:	68 a8 0b 00 00       	push   $0xba8
  e4:	6a 01                	push   $0x1
  e6:	e8 55 06 00 00       	call   740 <printf>
      exit();
  eb:	e8 e8 04 00 00       	call   5d8 <exit>
    printf(1, "cat: read error\n");
  f0:	50                   	push   %eax
  f1:	50                   	push   %eax
  f2:	68 ba 0b 00 00       	push   $0xbba
  f7:	6a 01                	push   $0x1
  f9:	e8 42 06 00 00       	call   740 <printf>
    exit();
...
double atof(const char *s){
 ...
 445:	0f 87 9d 00 00 00    	ja     4e8 <atof+0x158>
  double divisor = 10.0;   
 44b:	d9 05 e8 0b 00 00    	flds   0xbe8
  double fraction = 0.0;  
 451:	d9 ee                	fldz
 ...
 49b:	d9 c9                	fxch   %st(1)
    divisor *= 10.0;
 49d:	d8 0d e8 0b 00 00    	fmuls  0xbe8
  while('0' <= *fractionPart && *fractionPart <= '9'){
...
double fsqrt(double n) {
 ...
 528:	dd 45 08             	fldl   0x8(%ebp)
    double newtonianGuess = n / 2.0;
 52b:	d9 c0                	fld    %st(0)
 52d:	d8 0d ec 0b 00 00    	fmuls  0xbec
    for (int i = 0; i < 20; i++) {
 ...
 546:	d8 0d ec 0b 00 00    	fmuls  0xbec
    for (int i = 0; i < 20; i++) {
 ...
 688:	89 d1                	mov    %edx,%ecx
{
 ...
 6cb:	0f b6 92 48 0c 00 00 	movzbl 0xc48(%edx),%edx
 ...
 74c:	8b 4d 0c             	mov    0xc(%ebp),%ecx
{
 ...
 7b8:	ff 24 85 f0 0b 00 00 	jmp    *0xbf0(,%eax,4)
 7bf:	90                   	nop
  write(fd, &c, 1);
 ...
 8af:	d9 7d d6             	fnstcw -0x2a(%ebp)
          fraction_part *= 10;
 8b2:	d8 0d e8 0b 00 00    	fmuls  0xbe8
          int digit = (int) fraction_part;
 ...
 9e0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 9e5:	bf e0 0b 00 00       	mov    $0xbe0,%edi
...
free(void *ap)
{
 ...
 a21:	a1 e0 11 00 00       	mov    0x11e0,%eax
{
 ...
 a69:	5b                   	pop    %ebx
  freep = p;
 a6a:	89 15 e0 11 00 00    	mov    %edx,0x11e0
}
 a70:	5e                   	pop    %esi
 a71:	5f                   	pop    %edi
 a72:	5d                   	pop    %ebp
 ...
 aa7:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 aaa:	89 15 e0 11 00 00    	mov    %edx,0x11e0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 ac9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 acc:	8b 15 e0 11 00 00    	mov    0x11e0,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 b0b:	39 05 e0 11 00 00    	cmp    %eax,0x11e0
 ...
 b2e:	e8 ed fe ff ff       	call   a20 <free>
  return freep;
 b33:	8b 15 e0 11 00 00    	mov    0x11e0,%edx
 ...
 b5c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 b5f:	89 15 e0 11 00 00    	mov    %edx,0x11e0
}
 ...
 b6f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 b70:	c7 05 e0 11 00 00 e4 	movl   $0x11e4,0x11e0
 b77:	11 00 00 
    base.s.size = 0;
 b7a:	b8 e4 11 00 00       	mov    $0x11e4,%eax
    base.s.ptr = freep = prevp = &base;
 b7f:	c7 05 e4 11 00 00 e4 	movl   $0x11e4,0x11e4
 b86:	11 00 00 
    base.s.size = 0;
 b89:	c7 05 e8 11 00 00 00 	movl   $0x0,0x11e8
 b90:	00 00 00 
    if(p->s.size >= nunits){
