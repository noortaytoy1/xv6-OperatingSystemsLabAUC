...
main(int argc, char *argv[])
{
  ...
  33:	ff 33                	push   (%ebx)
  35:	e8 46 05 00 00       	call   580 <mkdir>
...
double atof(const char *s){
 ...
 385:	0f 87 9d 00 00 00    	ja     428 <atof+0x158>
  double divisor = 10.0;   
 38b:	d9 05 24 0b 00 00    	flds   0xb24
  double fraction = 0.0;  
 391:	d9 ee                	fldz
 ...
 3db:	d9 c9                	fxch   %st(1)
    divisor *= 10.0;
 3dd:	d8 0d 24 0b 00 00    	fmuls  0xb24
  while('0' <= *fractionPart && *fractionPart <= '9'){
...
double fsqrt(double n) {
 ...
 468:	dd 45 08             	fldl   0x8(%ebp)
    double newtonianGuess = n / 2.0;
 46b:	d9 c0                	fld    %st(0)
 46d:	d8 0d 28 0b 00 00    	fmuls  0xb28
    for (int i = 0; i < 20; i++) {
 ...
 486:	d8 0d 28 0b 00 00    	fmuls  0xb28
    for (int i = 0; i < 20; i++) {
 ...
 5c8:	89 d1                	mov    %edx,%ecx
{
 ...
 60b:	0f b6 92 84 0b 00 00 	movzbl 0xb84(%edx),%edx
 ...
 68c:	8b 4d 0c             	mov    0xc(%ebp),%ecx
{
 ...
 6f8:	ff 24 85 2c 0b 00 00 	jmp    *0xb2c(,%eax,4)
 6ff:	90                   	nop
  write(fd, &c, 1);
 ...
 7ef:	d9 7d d6             	fnstcw -0x2a(%ebp)
          fraction_part *= 10;
 7f2:	d8 0d 24 0b 00 00    	fmuls  0xb24
          int digit = (int) fraction_part;
 ...
 920:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 925:	bf 1b 0b 00 00       	mov    $0xb1b,%edi
...
free(void *ap)
{
 ...
 961:	a1 e4 0e 00 00       	mov    0xee4,%eax
{
 ...
 9a9:	5b                   	pop    %ebx
  freep = p;
 9aa:	89 15 e4 0e 00 00    	mov    %edx,0xee4
}
 9b0:	5e                   	pop    %esi
 9b1:	5f                   	pop    %edi
 9b2:	5d                   	pop    %ebp
 ...
 9e7:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 9ea:	89 15 e4 0e 00 00    	mov    %edx,0xee4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 a09:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 a0c:	8b 15 e4 0e 00 00    	mov    0xee4,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 a4b:	39 05 e4 0e 00 00    	cmp    %eax,0xee4
 ...
 a6e:	e8 ed fe ff ff       	call   960 <free>
  return freep;
 a73:	8b 15 e4 0e 00 00    	mov    0xee4,%edx
 ...
 a9c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 a9f:	89 15 e4 0e 00 00    	mov    %edx,0xee4
}
 ...
 aaf:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 ab0:	c7 05 e4 0e 00 00 e8 	movl   $0xee8,0xee4
 ab7:	0e 00 00 
    base.s.size = 0;
 aba:	b8 e8 0e 00 00       	mov    $0xee8,%eax
    base.s.ptr = freep = prevp = &base;
 abf:	c7 05 e8 0e 00 00 e8 	movl   $0xee8,0xee8
 ac6:	0e 00 00 
    base.s.size = 0;
 ac9:	c7 05 ec 0e 00 00 00 	movl   $0x0,0xeec
 ad0:	00 00 00 
    if(p->s.size >= nunits){
