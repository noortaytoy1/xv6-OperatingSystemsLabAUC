   ...
   f:	83 39 03             	cmpl   $0x3,(%ecx)
{
  ...
  17:	52                   	push   %edx
  18:	52                   	push   %edx
  19:	68 e8 0a 00 00       	push   $0xae8
  1e:	6a 02                	push   $0x2
  20:	e8 5b 06 00 00       	call   680 <printf>
    exit();
  25:	e8 ee 04 00 00       	call   518 <exit>
  }
  ...
  32:	e8 41 05 00 00       	call   578 <link>
  37:	83 c4 10             	add    $0x10,%esp
  3a:	85 c0                	test   %eax,%eax
  3c:	78 05                	js     43 <main+0x43>
    printf(2, "link %s %s: failed\n", argv[1], argv[2]);
  exit();
  3e:	e8 d5 04 00 00       	call   518 <exit>
    printf(2, "link %s %s: failed\n", argv[1], argv[2]);
  43:	ff 73 08             	push   0x8(%ebx)
  46:	ff 73 04             	push   0x4(%ebx)
  49:	68 fb 0a 00 00       	push   $0xafb
  4e:	6a 02                	push   $0x2
...
double atof(const char *s){
 ...
 385:	0f 87 9d 00 00 00    	ja     428 <atof+0x158>
  double divisor = 10.0;   
 38b:	d9 05 18 0b 00 00    	flds   0xb18
  double fraction = 0.0;  
 391:	d9 ee                	fldz
 ...
 3db:	d9 c9                	fxch   %st(1)
    divisor *= 10.0;
 3dd:	d8 0d 18 0b 00 00    	fmuls  0xb18
  while('0' <= *fractionPart && *fractionPart <= '9'){
...
double fsqrt(double n) {
 ...
 468:	dd 45 08             	fldl   0x8(%ebp)
    double newtonianGuess = n / 2.0;
 46b:	d9 c0                	fld    %st(0)
 46d:	d8 0d 1c 0b 00 00    	fmuls  0xb1c
    for (int i = 0; i < 20; i++) {
 ...
 486:	d8 0d 1c 0b 00 00    	fmuls  0xb1c
    for (int i = 0; i < 20; i++) {
 ...
 5c8:	89 d1                	mov    %edx,%ecx
{
 ...
 60b:	0f b6 92 78 0b 00 00 	movzbl 0xb78(%edx),%edx
 ...
 68c:	8b 4d 0c             	mov    0xc(%ebp),%ecx
{
 ...
 6f8:	ff 24 85 20 0b 00 00 	jmp    *0xb20(,%eax,4)
 6ff:	90                   	nop
  write(fd, &c, 1);
 ...
 7ef:	d9 7d d6             	fnstcw -0x2a(%ebp)
          fraction_part *= 10;
 7f2:	d8 0d 18 0b 00 00    	fmuls  0xb18
          int digit = (int) fraction_part;
 ...
 920:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 925:	bf 0f 0b 00 00       	mov    $0xb0f,%edi
...
free(void *ap)
{
 ...
 961:	a1 cc 0e 00 00       	mov    0xecc,%eax
{
 ...
 9a9:	5b                   	pop    %ebx
  freep = p;
 9aa:	89 15 cc 0e 00 00    	mov    %edx,0xecc
}
 9b0:	5e                   	pop    %esi
 9b1:	5f                   	pop    %edi
 9b2:	5d                   	pop    %ebp
 ...
 9e7:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 9ea:	89 15 cc 0e 00 00    	mov    %edx,0xecc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 a09:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 a0c:	8b 15 cc 0e 00 00    	mov    0xecc,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 a4b:	39 05 cc 0e 00 00    	cmp    %eax,0xecc
 ...
 a6e:	e8 ed fe ff ff       	call   960 <free>
  return freep;
 a73:	8b 15 cc 0e 00 00    	mov    0xecc,%edx
 ...
 a9c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 a9f:	89 15 cc 0e 00 00    	mov    %edx,0xecc
}
 ...
 aaf:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 ab0:	c7 05 cc 0e 00 00 d0 	movl   $0xed0,0xecc
 ab7:	0e 00 00 
    base.s.size = 0;
 aba:	b8 d0 0e 00 00       	mov    $0xed0,%eax
    base.s.ptr = freep = prevp = &base;
 abf:	c7 05 d0 0e 00 00 d0 	movl   $0xed0,0xed0
 ac6:	0e 00 00 
    base.s.size = 0;
 ac9:	c7 05 d4 0e 00 00 00 	movl   $0x0,0xed4
 ad0:	00 00 00 
    if(p->s.size >= nunits){
