...
main(int argc, char *argv[])
{
  ...
  38:	50                   	push   %eax
  39:	68 ea 0a 00 00       	push   $0xaea
  3e:	6a 01                	push   $0x1
  40:	e8 3b 06 00 00       	call   680 <printf>
  45:	8b 44 9f fc          	mov    -0x4(%edi,%ebx,4),%eax
  49:	83 c4 10             	add    $0x10,%esp
  4c:	39 de                	cmp    %ebx,%esi
  4e:	75 e0                	jne    30 <main+0x30>
  50:	68 ef 0a 00 00       	push   $0xaef
  55:	50                   	push   %eax
  56:	68 ea 0a 00 00       	push   $0xaea
  5b:	6a 01                	push   $0x1
  5d:	e8 1e 06 00 00       	call   680 <printf>
  62:	83 c4 10             	add    $0x10,%esp
  exit();
  65:	e8 ae 04 00 00       	call   518 <exit>
  6a:	66 90                	xchg   %ax,%ax
  6c:	66 90                	xchg   %ax,%ax
  6e:	66 90                	xchg   %ax,%ax
  70:	66 90                	xchg   %ax,%ax
...
double atof(const char *s){
 ...
 385:	0f 87 9d 00 00 00    	ja     428 <atof+0x158>
  double divisor = 10.0;   
 38b:	d9 05 f8 0a 00 00    	flds   0xaf8
  double fraction = 0.0;  
 391:	d9 ee                	fldz
 ...
 3db:	d9 c9                	fxch   %st(1)
    divisor *= 10.0;
 3dd:	d8 0d f8 0a 00 00    	fmuls  0xaf8
  while('0' <= *fractionPart && *fractionPart <= '9'){
...
double fsqrt(double n) {
 ...
 468:	dd 45 08             	fldl   0x8(%ebp)
    double newtonianGuess = n / 2.0;
 46b:	d9 c0                	fld    %st(0)
 46d:	d8 0d fc 0a 00 00    	fmuls  0xafc
    for (int i = 0; i < 20; i++) {
 ...
 486:	d8 0d fc 0a 00 00    	fmuls  0xafc
    for (int i = 0; i < 20; i++) {
 ...
 5c8:	89 d1                	mov    %edx,%ecx
{
 ...
 60b:	0f b6 92 58 0b 00 00 	movzbl 0xb58(%edx),%edx
 ...
 68c:	8b 4d 0c             	mov    0xc(%ebp),%ecx
{
 ...
 6f8:	ff 24 85 00 0b 00 00 	jmp    *0xb00(,%eax,4)
 6ff:	90                   	nop
  write(fd, &c, 1);
 ...
 7ef:	d9 7d d6             	fnstcw -0x2a(%ebp)
          fraction_part *= 10;
 7f2:	d8 0d f8 0a 00 00    	fmuls  0xaf8
          int digit = (int) fraction_part;
 ...
 920:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 925:	bf f1 0a 00 00       	mov    $0xaf1,%edi
...
free(void *ap)
{
 ...
 961:	a1 b4 0e 00 00       	mov    0xeb4,%eax
{
 ...
 9a9:	5b                   	pop    %ebx
  freep = p;
 9aa:	89 15 b4 0e 00 00    	mov    %edx,0xeb4
}
 9b0:	5e                   	pop    %esi
 9b1:	5f                   	pop    %edi
 9b2:	5d                   	pop    %ebp
 ...
 9e7:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 9ea:	89 15 b4 0e 00 00    	mov    %edx,0xeb4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 a09:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 a0c:	8b 15 b4 0e 00 00    	mov    0xeb4,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 a4b:	39 05 b4 0e 00 00    	cmp    %eax,0xeb4
 ...
 a6e:	e8 ed fe ff ff       	call   960 <free>
  return freep;
 a73:	8b 15 b4 0e 00 00    	mov    0xeb4,%edx
 ...
 a9c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 a9f:	89 15 b4 0e 00 00    	mov    %edx,0xeb4
}
 ...
 aaf:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 ab0:	c7 05 b4 0e 00 00 b8 	movl   $0xeb8,0xeb4
 ab7:	0e 00 00 
    base.s.size = 0;
 aba:	b8 b8 0e 00 00       	mov    $0xeb8,%eax
    base.s.ptr = freep = prevp = &base;
 abf:	c7 05 b8 0e 00 00 b8 	movl   $0xeb8,0xeb8
 ac6:	0e 00 00 
    base.s.size = 0;
 ac9:	c7 05 bc 0e 00 00 00 	movl   $0x0,0xebc
 ad0:	00 00 00 
    if(p->s.size >= nunits){
